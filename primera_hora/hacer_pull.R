...
# Desarrollo
# Se tiene una serie de códigos los cuales deberán irse corriento línea a 
#línea, recordar que siempre se ejecuta una línea presionando Ctrl + Enter
...
# En este paso vamos a crear vectores, siempre serán de la forma 
#c(elem1, elem2, ...)
...
# Se puede acceder a las coordenadas de un vector haciendo uso de 
#[] y su posición
...
# También se pueden generar vectores que no sean sucesivos con la función 
#seq, intenta cambiar el valor de los argumentos y observa el comportamiento 
#de los vectores
...
# Para repetir un número o un vector un determinado número de 
#ocasiones utilizamos rep
...
# Reciclaje, al hacer operaciones entre vectores, R repetirá los valores del 
#vector, hasta alcanzar la dimensión requerida

c(1, 2) + c(7, 8, 9, 10)

# Existen varias operaciones entre vectores, intenta probar algunas de las 
#siguientes:
